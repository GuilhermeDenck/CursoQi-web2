...
<html style="font-size: 16px;">
  ...
  <body data-home-page="Página-Inicial.html" data-home-page-title="Página Inicial" class="u-body"><header class="u-clearfix u-header u-header" id="sec-1337"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1" class="testFundo">
      ...
      <form style="width: 40%; margin: 100px auto;" action="../controle/olho.controle.php?op=cadastrar" method="post">
        <div class="form-group">
            ...
            <div class="text-center">
                <div class="input-group-prepend">
                    <div >
                    <img  src="../images/dalto1.png"  class="rounded" width="660px"> 
                    </div>

            <div class="input-group mt-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Digite o número da imagem</span>
                </div>
                 <input type="number" name="txtdalto1" class="form-control">
            </div>
            ...
            <div class="text-center">
                <div class="input-group-prepend">
                    <div >
                    <img  src="../images/dalto2.png"  class="rounded" width="660px"> 
                    </div>
                    <div class="input-group mt-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Digite o número da imagem</span>
                </div>
                 <input type="number" name="txtdalto2" class="form-control">
                </div>
                </div> 
            </div>           
            ...
            <div class="text-center">
                <div class="input-group-prepend">
                    <div >
                    <img  src="../images/dalto3.jpg"  class="rounded" width="660px"> 
                    </div>
                    <div class="input-group mt-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Digite o número da imagem</span>
                </div>
                 <input type="number" name="txtdalto3" class="form-control">
                </div>
                </div> 
            </div>           
            ...
            <div class="text-center">
                <div class="input-group-prepend">
                    <div >
                    <img  src="../images/dalto4.png"  class="rounded" width="660px"> 
                    </div>
                    <div class="input-group mt-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Digite o número da imagem</span>
                </div>
                 <input type="number" name="txtdalto4" class="form-control">
                </div>
                </div> 
            </div>           
